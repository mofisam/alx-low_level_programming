...
/**
 * check_elf - Verifies whether the provided file is an ELF file.
 * @e_id: A pointer to an array containing the ELF magic numbers.
 *
 * Description: Exits with code 98 if the file
 * is not recognized as an ELF file.
 */
void check_elf(unsigned char *e_id)
{
	int index;
...
/**
 * print_magic - Displays the magic numbers from an ELF header.
 * @e_id: A pointer to an array containing the ELF magic numbers.
 *
 * Description: Magic numbers are presented with spaces between them.
 */
void print_magic(unsigned char *e_id)
{
	int index;
...
/**
 * print_class - Displays the class information of an ELF header.
...
/**
 * print_type - Displays the type information of an ELF header.
 * @e_type: The ELF type.
 * @e_id: A pointer to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_id)
...
/**
 * print_entry - Displays the entry point information from an ELF header.
...
/**
 * main - Outputs the information found in the ELF header
